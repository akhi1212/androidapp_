...
public class QuestionReviewAdapter extends RecyclerView.Adapter<QuestionReviewAdapter.MyViewHolder> {
    ...
    public QuestionReviewAdapter(Context context, ArrayList<Question> dataSet){
        this.context = context;
        this.dataSet = dataSet;
    }

    public QuestionReviewAdapter(Context context, ArrayList<Question> dataSet, String sport){
        this.context = context;
        this.dataSet = dataSet;
        this.sport = sport;
    }
            ...
            public void onClick(View view) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        FirebaseDatabase.getInstance().getReference().child("quizQuestions").child(sport)
                                .child(question.getId()).removeValue();
    ...
    private Dialog onCreateDialog(int position){
